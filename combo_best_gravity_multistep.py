...
class ComboBestGravityMultistep(ParametrizedGeneticAlgorithm):
    def reproduction(self, mating_population: List[S]) -> List[S]:
        ...
        for i in range(0, self.offspring_population_size, number_of_parents_to_combine):
            ...
            for solution in offspring:
                ...
                # "Combo Best Gravity Multistep" mutation
                if len(offspring_population) > 0:
                    # Follow part
                    # get top individuals in current population
                    best_individuals = self.solutions[: ComboBestGravityMultistep.N]
                    ...
                    worst_individuals = self.solutions[-ComboBestGravityMultistep.N :]
    ...
    def get_name(self) -> str:
        return "GA with 'Combo Best Gravity Multistep' mutation"
